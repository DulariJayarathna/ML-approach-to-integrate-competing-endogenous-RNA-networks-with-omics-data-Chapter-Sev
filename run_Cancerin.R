...
coefs= get_nonzero_coef_lasso(regression.data = regression.data) ####TAKES TIME
# get frequency of selected predictors 
bt.interval.dt = get_bootstrap_confidence_interval(regression.data = regression.data) ####TAKES TIME
...
pair.dt_BRCA = get_empirical_pvalue_sensitivity_correlation(pair.dt = pair.dt, 
